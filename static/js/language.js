...
const translations = {
    en: {
        ...
        // Marquee
        marquee: {
            announcement: "🙏 All devotees please note! Bhajan Sandhya will be organized on Tuesday, May 28, from 7:00 PM to 10:00 PM at Shri Ramdwara, Chittorgarh. Hearty invitation 🙏"
        },
        // Language Popup
        popup: {
        ...
        videos: {
            ...
            video1Desc: "Digvijayram Ji Maharaj explains the mind’s tendencies and practical ways to master them.",
            video1Date: "YouTube • 1 day ago",
            ...
            video2Date: "YouTube • 3 days ago",
            video3Title: "Blessings at the Sanatan Hindu Ekta padyatra",
            video3Desc: "Highlights of Maharaj Ji’s inspiring words from the unity march.",
            video3Date: "YouTube • 4 days ago",
            ...
            video5Date: "YouTube • 5 days ago",
            video6Title: "What is the supreme purpose of human life?",
            video6Desc: "A clear explanation of life’s ultimate goal by Maharaj Ji.",
            video6Date: "YouTube • 7 days ago",
    ...
    hi: {
        ...
        nav: {
            ...
            project1: "प्रोजेक्ट 1",
            project2: "प्रोजेक्ट 2",
            project3: "प्रोजेक्ट 3",
            photos: "फोटो",
            videos: "वीडियो",
            events: "कार्यक्रम",
            donate: "दान करें",
        ...
        // Home Page
        home: {
            title: "संत भगत राम धार्मिक सेवा संस्थान चितौड़गढ़",
            subtitle: "समाज सेवा और धार्मिक कार्यों के लिए समर्पित",
            objectives: "उद्देश्य",
            objective1: "पीड़ित मानवता की हर प्रकार से सेवा करना जो कि बिना किसी धर्म जाति लिंग सामाजिक प्रतिष्ठा एवं धर्म के भेदभाव के बिना की जावेगी।",
            objective2: "बीमार व्यक्तियों की चिकित्सा एवं सेवा करना एवं इसमें सहयोग करना।",
            objective3: "अस्पताल बनाना एवं संचालन करना चिकित्सा से संबंधित भवन निर्माण करना इत्यादि।",
            objective4: "चिकित्सालय में भर्ती रोगियों के लिए भोजन व्यवस्था करना जहां राज्य के तौर पर सुविधा उपलब्ध नहीं है।",
            objective5: "आदिवासी एवं ग्रामीण क्षेत्रों में निशुल्क पौष्टिक आहार उपलब्ध कराना।",
            objective6: "आदिवासी एवं ग्रामीण एवं शहरी गरीबों अनुसूचित जातियों जनजातियों के लिए विभिन्न प्रकार के प्रशिक्षणात्मक केंद्रों का संचालन एवं निर्देशन करना।",
        ...
        // Marquee
        marquee: {
            announcement: "🙏 सभी श्रद्धालुजन ध्यान दें! भजन संध्या का आयोजन दिनांक 28 मई, मंगलवार को शाम 7:00 बजे से 10:00 बजे तक श्री रामद्वारा, चित्तौड़गढ़ में किया जाएगा। सादर आमंत्रण 🙏"
        },
        // Language Popup
        popup: {
        ...
        blog: {
            title: "ब्लॉग",
            subtitle: "हमारे कार्यों, कार्यक्रमों और सेवा गतिविधियों के बारे में अपडेट",
            datePrefix: "दिनांक:",
            categorySeva: "सेवा",
            categoryEvent: "कार्यक्रम",
            categoryTraining: "प्रशिक्षण",
            categoryFood: "भोजन वितरण",
            categoryReligious: "धार्मिक",
            categoryEducation: "शिक्षा",
            readMore: "पढ़ना जारी रखें →",
            readLess: "कम पढ़ें ←",
            backToBlogs: "← ब्लॉग पर वापस जाएं",
            share: "शेयर करें",
            post1Title: "ग्रामीण क्षेत्रों में निशुल्क चिकित्सा शिविर",
            post1Excerpt: "हमने ग्रामीण क्षेत्रों में एक निशुल्क चिकित्सा शिविर का आयोजन किया जहां सैकड़ों लोगों को चिकित्सा सुविधाएं प्रदान की गईं।",
            post2Title: "भजन संध्या का सफल आयोजन",
            post2Excerpt: "श्री रामद्वारा में आयोजित भजन संध्या में सैकड़ों श्रद्धालुओं ने भाग लिया और आध्यात्मिक आनंद प्राप्त किया।",
            post3Title: "युवाओं के लिए कौशल विकास कार्यक्रम",
            post3Excerpt: "हमने युवाओं के लिए एक कौशल विकास कार्यक्रम शुरू किया जिसमें 50 से अधिक युवाओं ने भाग लिया।",
            post4Title: "गरीब परिवारों को पौष्टिक भोजन वितरण",
            post4Excerpt: "हमने 200 से अधिक गरीब परिवारों को पौष्टिक भोजन वितरित किया और उनकी मदद की।",
            post5Title: "विशेष धार्मिक सभा का आयोजन",
            post5Excerpt: "संत भगत राम जी के मार्गदर्शन में एक विशेष धार्मिक सभा का आयोजन किया गया जिसमें सभी ने आध्यात्मिक ज्ञान प्राप्त किया।",
            post6Title: "बच्चों के लिए शैक्षिक कार्यक्रम",
            post6Excerpt: "हमने गरीब बच्चों के लिए एक शैक्षिक कार्यक्रम शुरू किया जिसमें उन्हें निशुल्क शिक्षा और सामग्री प्रदान की जा रही है।"
        },
        // Photos Page
        photos: {
            title: "फोटो गैलरी",
            subtitle: "हमारे विभिन्न कार्यक्रमों और उत्सवों की सुंदर यादें",
            viewPhotos: "तस्वीरें देखें",
            photosLabel: "तस्वीरें",
            emptyState: "जल्द ही फोटो जोड़े जाएंगे।",
            noPhotos: "जल्द ही तस्वीरें जोड़ी जाएंगी।"
        },
        // Videos Page
        videos: {
            title: "वीडियो गैलरी",
            subtitle: "हमारे धार्मिक कार्यक्रमों, भजन संध्या और सेवा कार्यों के वीडियो",
            all: "सभी",
            bhajan: "भजन संध्या",
            seva: "सेवा कार्य",
            events: "कार्यक्रम",
            sermons: "प्रवचन",
            video1Title: "जानिए मन की वृत्ति कैसी है | और इसे वश में कैसे करें ?",
            video1Desc: "दिग्विजयराम जी महाराज मन की वृत्ति और उसे साधने के उपाय समझा रहे हैं।",
            video1Date: "यूट्यूब • 1 दिन पहले",
            video2Title: "आत्मदेव व धुंधकारी की कथा से संतोष कैसे पाएं?",
            video2Desc: "हर असंतुष्ट व्यक्ति के लिए आत्मदेव और धुंधकारी की कथा प्रेरक संदेश देती है।",
            video2Date: "यूट्यूब • 3 दिन पहले",
            video3Title: "सनातन हिंदू एकता पदयात्रा में आशीर्वचन",
            video3Desc: "पदयात्रा में पूज्य दिग्विजयरामदास जी महाराज के ओजस्वी आशीर्वचन।",
            video3Date: "यूट्यूब • 4 दिन पहले",
            video4Title: "राम प्रेमी संत दिग्विजयराम जी की पदयात्रा",
            video4Desc: "बागेश्वर महाराज की पदयात्रा में पहुँचे संत दिग्विजयराम जी महाराज के दर्शन।",
            video4Date: "यूट्यूब • 4 दिन पहले",
            video5Title: "कलियुग में भागवत का महत्व क्यों?",
            video5Desc: "भागवत कथा कैसे कलियुग में उद्धार का मार्ग बनती है इस पर चर्चा।",
            video5Date: "यूट्यूब • 5 दिन पहले",
            video6Title: "मानव जीवन का सबसे बड़ा उद्देश्य क्या है?",
            video6Desc: "जीवन के परम उद्देश्य को महाराज जी सरल भाषा में समझा रहे हैं।",
            video6Date: "यूट्यूब • 7 दिन पहले",
            watchOnYoutube: "यूट्यूब पर देखें"
        },
        // Donate Page
        donate: {
            heroTitle: "दान करें और सेवा में सहयोग करें",
            heroSubtitle: "आपका दान हमारे समाज सेवा के कार्यों को आगे बढ़ाने में मदद करता है",
            regularDonation: "नियमित दान",
            regularDesc: "मासिक या वार्षिक दान करके हमारे कार्यों में निरंतर सहयोग करें",
            oneTimeDonation: "एकमुश्त दान",
            oneTimeDesc: "एक बार में दान करके हमारी सेवा में योगदान दें",
            specialDonation: "विशेष दान",
            specialDesc: "विशेष कार्यक्रमों या परियोजनाओं के लिए दान करें",
            ...
            cardPayment: "Card Payment",
            cardDesc: "Credit/Debit Card",
            payWithCard: "कार्ड से भुगतान",
            donationInfo: "दान की जानकारी",
            name: "नाम *",
            email: "ईमेल *",
            phone: "फोन नंबर *",
            amount: "दान राशि (₹) *",
            ...
            agreement: "मैं दान करने के लिए सहमत हूं और मुझे पता है कि यह राशि वापस नहीं की जाएगी",
            submitDonate: "दान करें 🙏",
            impact: "आपके दान का प्रभाव",
            familiesHelped: "परिवारों की मदद",
            programsOrganized: "कार्यक्रम आयोजित",
            peopleReached: "लोगों तक पहुंच",
            serviceAvailable: "सेवा उपलब्ध",
            popular: "⭐ लोकप्रिय"
        },
        // Events Page
        events: {
            title: "कार्यक्रम और कैलेंडर",
            subtitle: "हमारे आगामी कार्यक्रमों और आध्यात्मिक सभाओं के साथ अपडेट रहें",
